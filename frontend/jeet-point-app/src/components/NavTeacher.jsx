    ...
    <nav className="bg-violet-100 p-2 px-5 top-0 z-50 m-3 rounded-4xl shadow-md">
      <div className="container mx-auto flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center text-base md:text-xl space-x-8">
          <NavLink to="/TeacherDASH" end className={navLinkClass}>
            Dashboard
          </NavLink>
          <NavLink to="/TeacherDASH/contests" className={navLinkClass}>
            My Contests
          </NavLink>
          <NavLink to="/TeacherDASH/contributions" className={navLinkClass}>
            My Contributions
          </NavLink>
        </div>
      ...
      {isOpen && (
        <div className="md:hidden px-4 pb-4">
          <div className="flex flex-col space-y-2">
            <NavLink to="/TeacherDASH" end className={navLinkClass} onClick={() => setIsOpen(false)}>
              Dashboard
            </NavLink>
            <NavLink to="/TeacherDASH/contests" className={navLinkClass} onClick={() => setIsOpen(false)}>
              My Contests
            </NavLink>
            <NavLink to="/TeacherDASH/contributions" className={navLinkClass} onClick={() => setIsOpen(false)}>
              My Contributions
            </NavLink>
